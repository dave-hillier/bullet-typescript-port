...
export class btRigidBodyConstructionInfo {
    constructor(mass, motionState, collisionShape, localInertia = new btVector3(0, 0, 0)) {
        this.m_mass = mass;
...
export class btRigidBody extends btCollisionObject {
    constructor(constructionInfoOrMass, motionState, collisionShape, localInertia = new btVector3(0, 0, 0)) {
        super();
...
// Static constants
btRigidBody.CF_STATIC_OBJECT = btCollisionObject.CollisionFlags.CF_STATIC_OBJECT;
btRigidBody.CO_RIGID_BODY = btCollisionObject.CollisionObjectTypes.CO_RIGID_BODY;
