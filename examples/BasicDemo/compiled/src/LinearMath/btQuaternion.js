...
import { btSqrt, btCos, btSin, btAcos, btAsin, btAtan2, btFabs, btAssert, SIMD_PI, SIMD_EPSILON } from './btScalar';
/**
...
export class btQuaternion extends btQuadWord {
    ...
    setRotation(axis, angle) {
        ...
        this.setValue(axis.x() * s, axis.y() * s, axis.z() * s, btCos(angle * 0.5));
    }
    /**
 ...
 */
export function btMultiplyQuaternion(q1, q2) {
 ...
 * @returns Product quaternion
 */
export function btMultiplyQuaternionVector(q, w) {
 ...
 * @returns Product quaternion
 */
export function btMultiplyVectorQuaternion(w, q) {
 ...
 * @returns Interpolated quaternion
 */
export function btSlerp(q1, q2, t) {
    return q1.slerp(q2, t);
}
/**
 ...
 */
export function btQuatRotate(rotation, v) {
 ...
 */
export function btShortestArcQuat(v0, v1) {
    const c = v0.cross(v1);
    const d = v0.dot(v1);
 ...
 * @returns Shortest arc rotation quaternion
 */
export function btShortestArcQuatNormalize2(v0, v1) {
    v0.normalize();
    v1.normalize();
