...
export class btTransform {
    ...
    inverseTimes(t) {
        ...
        return new btTransform(this.m_basis.transposeTimes(t.m_basis), multiplyMatrixVector(this.m_basis.transpose(), v));
    }
    /**
     ...
     */
    multiply(t) {
        return new btTransform(multiplyMatrices(this.m_basis, t.m_basis), this.transformPoint(t.m_origin));
    }
    /**
 ...
 * @returns True if transforms are equal
 */
export function btTransformEquals(t1, t2) {
    return t1.equals(t2);
}
