...
export class btVector3 extends btQuadWord {
     ...
     */
    constructor(other: btVector3);
    constructor(x?: number | btVector3, y?: number, z?: number) {
     ...
     */
    addAssign(v: btVector3): btVector3 {
     ...
     * @returns Reference to this vector
     */
    subtractAssign(v: btVector3): btVector3 {
        this.m_floats[0] -= v.m_floats[0];
        this.m_floats[1] -= v.m_floats[1];
        this.m_floats[2] -= v.m_floats[2];
        return this;
     ...
     * @returns Reference to this vector
     */
    multiplyAssign(s: number): btVector3 {
        this.m_floats[0] *= s;
        this.m_floats[1] *= s;
        this.m_floats[2] *= s;
        return this;
     ...
     * @returns Reference to this vector
     */
    multiplyAssignVector(v: btVector3): btVector3 {
        this.m_floats[0] *= v.m_floats[0];
        this.m_floats[1] *= v.m_floats[1];
        this.m_floats[2] *= v.m_floats[2];
        return this;
     ...
     * @returns Reference to this vector
     */
    divideAssign(s: number): btVector3 {
     ...
     */
    subtract(v: btVector3): btVector3 {
        return new btVector3(
            this.m_floats[0] - v.m_floats[0],
            this.m_floats[1] - v.m_floats[1],
            this.m_floats[2] - v.m_floats[2]
     ...
     */
    multiplyVector(v: btVector3): btVector3 {
        return new btVector3(
            this.m_floats[0] * v.m_floats[0],
            this.m_floats[1] * v.m_floats[1],
            this.m_floats[2] * v.m_floats[2]
     ...
     */
    maxDot(array: btVector3[], dotOut: { value: number }): number {
     ...
     */
    minDot(array: btVector3[], dotOut: { value: number }): number {
     ...
     */
    static subtract(v1: btVector3, v2: btVector3): btVector3 {
        return v1.subtract(v2);
    }

    /**
     * Multiply vector by scalar (static version)
     * @param v Vector
     * @param s Scalar
     * @returns Scaled vector
     */
    static multiply(v: btVector3, s: number): btVector3;
    static multiply(s: number, v: btVector3): btVector3;
    static multiply(v1: btVector3, v2: btVector3): btVector3;
    static multiply(arg1: btVector3 | number, arg2: btVector3 | number): btVector3 {
    ...
    /**
     * Divide vector by scalar (static version)
     * @param v Vector
     * @param s Scalar
     * @returns Divided vector
     */
    static divide(v: btVector3, s: number): btVector3;
    static divide(v1: btVector3, v2: btVector3): btVector3;
    static divide(v1: btVector3, arg2: number | btVector3): btVector3 {
        if (typeof arg2 === 'number') {
            return v1.divide(arg2);
        } else {
            return new btVector3(
                v1.m_floats[0] / arg2.m_floats[0],
                v1.m_floats[1] / arg2.m_floats[1],
                v1.m_floats[2] / arg2.m_floats[2]
            );
        }
    }
     ...
     */
    static negate(v: btVector3): btVector3 {
        return v.negate();
    }
     ...
     * @returns Dot product
     */
    static dot(v1: btVector3, v2: btVector3): number {
        return v1.dot(v2);
    }
     ...
     * @returns Distance squared
     */
    static distance2(v1: btVector3, v2: btVector3): number {
     ...
     * @returns Distance
     */
    static distance(v1: btVector3, v2: btVector3): number {
     ...
     */
    static angle(v1: btVector3, v2: btVector3): number {
        return v1.angle(v2);
    }
     ...
     */
    static cross(v1: btVector3, v2: btVector3): btVector3 {
        return v1.cross(v2);
    }
     ...
     */
    static triple(v1: btVector3, v2: btVector3, v3: btVector3): number {
     ...
     * @returns Interpolated vector
     */
    static lerp(v1: btVector3, v2: btVector3, t: number): btVector3 {
        return v1.lerp(v2, t);
    }
}
 ...
 * @returns Dot product
 */
export function btDot(v1: btVector3, v2: btVector3): number {
    return v1.dot(v2);
}
 ...
 * @returns Distance squared
 */
export function btDistance2(v1: btVector3, v2: btVector3): number {
    return v1.distance2(v2);
}
 ...
 * @returns Distance
 */
export function btDistance(v1: btVector3, v2: btVector3): number {
    return v1.distance(v2);
}
 ...
 * @returns Angle in radians
 */
export function btAngle(v1: btVector3, v2: btVector3): number {
    return v1.angle(v2);
}
 ...
 * @returns Cross product
 */
export function btCross(v1: btVector3, v2: btVector3): btVector3 {
    return v1.cross(v2);
}
 ...
 * @returns Scalar triple product
 */
export function btTriple(v1: btVector3, v2: btVector3, v3: btVector3): number {
    return v1.triple(v2, v3);
}
 ...
 * @returns Interpolated vector
 */
export function lerp(v1: btVector3, v2: btVector3, t: number): btVector3 {
    return v1.lerp(v2, t);
}
 ...
 */
export function btPlaneSpace1(n: btVector3, p: btVector3, q: btVector3): void {
...
export class btVector4 extends btVector3 {
    ...
    constructor(rhs: btVector3);
    constructor(x?: number | btVector3, y?: number, z?: number, w?: number) {
        if (x instanceof btVector3) {
            super(x);
